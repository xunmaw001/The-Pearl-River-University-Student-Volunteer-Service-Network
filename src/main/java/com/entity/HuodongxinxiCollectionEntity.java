...
public class HuodongxinxiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public HuodongxinxiCollectionEntity() {

	}

	public HuodongxinxiCollectionEntity(T t) {
		try {
     ...
     * 类型
     */
    @TableField(value = "huodongxinxi_collection_types")
    ...
    public String toString() {
        return "HuodongxinxiCollection{" +
            "id=" + id +
            ", huodongxinxiId=" + huodongxinxiId +
            ", yonghuId=" + yonghuId +
            ", huodongxinxiCollectionTypes=" + huodongxinxiCollectionTypes +
