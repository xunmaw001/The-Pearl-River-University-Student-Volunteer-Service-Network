...
public class HuodongxinxiCollectionView extends HuodongxinxiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String huodongxinxiCollectionValue;
	...
	public HuodongxinxiCollectionView() {

	}

	public HuodongxinxiCollectionView(HuodongxinxiCollectionEntity huodongxinxiCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, huodongxinxiCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getHuodongxinxiCollectionValue() {
				return huodongxinxiCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setHuodongxinxiCollectionValue(String huodongxinxiCollectionValue) {
				this.huodongxinxiCollectionValue = huodongxinxiCollectionValue;
			}
