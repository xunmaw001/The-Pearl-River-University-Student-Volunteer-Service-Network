...
public class HuodongxinxiOrderView extends HuodongxinxiOrderEntity implements Serializable {
	...
	public HuodongxinxiOrderView() {

	}

	public HuodongxinxiOrderView(HuodongxinxiOrderEntity huodongxinxiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, huodongxinxiOrderEntity);
